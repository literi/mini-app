<template>
  <view>
    <LayoutView @updateView="handelView">
      <custom-wrapper>
...
import Mine from "./fragment/mine.vue";
import Product from "./fragment/product.vue";
import Msg from "./fragment/msg.vue";
            ...
            Taro.request({
              ...
              success: res => {
                ...
                if (mylogininfo != null) {
                  ...
                  Taro.request({
                    method: "post",
                    url: that.globalData.path + "/miniLogin/loginCheck.ajax",
                    header: {
